          ...
          <ul className="div_card">
            {filtroData.map((obj) => {
              ...
              <li className="card" key={filtroData.indexOf(obj)}>
                ...
                <button className="card_btn">{obj.secao}</button>
                ...
                <p onClick={() => setCarrinho([...carrinho,{titulo:obj.titulo, id: uuidv4(), valor: obj.valor, img: obj.img}])}
                className="card_adicionar paddingLeft">
